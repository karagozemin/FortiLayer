...
const FirewallStatus: React.FC = () => {
  ...
  const fetchMetrics = useCallback(async () => {
    ...
    try {
      ...
      const [screened, passed, blocked, fwPaused, peAddr, pePaused, tPaused, vaultAuth, policies] = await Promise.all([
        fw.totalScreened(), fw.totalPassed(), fw.totalBlocked(),
        fw.paused(), fw.policyEngine(),
        pe.paused(),
        treasury.paused(),
      ...
      setM({
        ...
        isPaused: fwPaused, isOwner: true,
