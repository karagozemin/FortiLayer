...
export const ABIS = {
  ...
  // Stylus (Rust/WASM) SpendingLimitPolicy — function names follow Stylus SDK camelCase conversion
  SpendingLimitPolicy: [
    ...
    'function getRemainingAllowance(address vault) view returns (uint256)',
    ...
    'function recordTransaction(address vault, address token, address to, uint256 amount)',
    'function initialize(address engine, uint256 dailyLimit, uint256 maxTxAmount)',
    // Stylus custom errors
    ...
    'error MaxTransactionExceeded(address vault, uint256 amount, uint256 maxAmount)',
  ],
